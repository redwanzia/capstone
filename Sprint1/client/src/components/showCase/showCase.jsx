...
class Showcase extends Component {
  ...
  render() { 
    return ( 
      ...
      <p className='showCase__imgText'>“Cancer is just a <span className='showCase__span'>chapter</span> chapter in our lives and not the  <span className='showCase__span'>whole story</span>.”</p>    
      </figure>
        ...
        <div className="showCase__quote" >
          <div className="showCase__quote__wrap">
            <p className="showCase__quote__text">“The best thing to do is take one day at a time, be positive, pick your head up when you are down and remember what may seem like the most devastating news in your life, can always open doors to a whole new world of possibilities.”</p>
            <div className="showCase__quote__composition" >
              <img className="showCase__quote__jesseca" src={Jesseca}></img>             
              <img className="showCase__quote__henry" src={Henry} ></img>
              <img className="showCase__quote__kaitlin" src={Kaitlin} ></img>
            </div> 
          </div> 
        </div> 
